  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-white mb-2">确认选题</h2>
        <p className="text-zinc-400">确认选题信息和食材清单后开始制作</p>
      </div>
      ...
      <div className="card-elegant p-6 space-y-6">
        ...
        <div className="flex gap-5">
          {/* 海报 */}
          <div className="w-32 h-48 rounded-lg overflow-hidden shrink-0 bg-gradient-to-br from-zinc-700 to-zinc-800 flex items-center justify-center">
            {topic.poster_url ? (
              <img
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <span className="score-badge text-lg">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-medium text-white">{topic.recommended_dish}</span>
              </div>
              <span className={`px-3 py-1 rounded-full text-sm border ${difficultyColors[topic.cooking_difficulty] || difficultyColors['中等']}`}>
        ...
        <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
          <h4 className="text-sm font-semibold text-zinc-400 mb-2">美食场景</h4>
          <p className="text-zinc-300 leading-relaxed">{topic.food_scene_description}</p>
        </div>
      </div>
